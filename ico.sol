...
import "./digitosToken.sol";



contract DigitosICO is Digitos{
   ...
   receive () payable external{
    ...
    function transfer(address to, uint tokens) public override returns (bool success){
        ...
        super.transfer(to, tokens);  // same as Digitos.transfer(to, tokens);
        return true;
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success){
        ...
        Digitos.transferFrom(from, to, tokens);  // same as super.transferFrom(to, tokens);
        return true;
